...
int main()
{
	...
	const string data_s[2] = { "data/solutions.txt", "data/solutions2.txt" };
	...
	for (int i = 0; i < 11; i++)
	{
		...
		int minPenalty2 = alg2.dummyCode();
	...
	//	int minPenalty2 = alg.dummyCode();

	//	//cout << "File: " << data_p[i] << endl;
	//	//cout << "Minimum Penalty using Dummy Code: " << minPenalty << endl;

	//	algorytmy2.push_back(alg);
	//	sum += minPenalty2;
	//}
	//write_data(data_s[1], algorytmy2, "\t*****\nDummy Code\n\t*****");
}
